...
module.exports = {
    "Where_are_stop_numbers": [
        "These stop numbers are printed on the bus stop signs. You can also send me the nearest cross streets or address and I'll send you stops that are within a mile."
        ],
    "hello":[
